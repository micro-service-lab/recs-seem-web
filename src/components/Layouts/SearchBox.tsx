    ...
    <>
      <div className="sm:ltr:mr-auto sm:rtl:ml-auto flex items-center space-x-2">
        <button
          ...
          className="search_btn p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
        >
                  ...
                  <div className="flex flex-col-reverse sm:flex-row w-full justify-between sm:px-3 pt-1 sm:pt-0 items-end sm:items-center sm:my-4">
                    <form className="mb-2 w-full sm:w-5/6 pt-2">
                      <div className="relative w-11/12 mx-auto">
                        ...
                        <button
                          type="button"
                          className="btn btn-primary absolute ltr:right-1 rtl:left-1 inset-y-0 m-auto rounded-full w-9 h-9 p-0 flex items-center justify-center cursor-default"
                        >
                          <IconSearch className="w-4.5 h-4.5 mx-auto dark:text-[#d0d2d6]" />
                        </button>
                      </div>
                            ...
                            text-gray-500 font-semibold hover:text-primary transition-all duration-150 hover:border border-dashed border-success cursor-pointer py-4"
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div
                                    className={`mx-2 px-2 badge badge-outline-info border-1 ring-indigo-300 ring-2 ring-offset-2 rounded-lg border-spacing-4.5`}
                                  >
                                    {item.link}
                                  </div>
                                </div>
