...
export const API_RESPONSE_HANDLING: MessageType = {
  ...
  [API_RESPONSE_TYPES.PrivateChatRoomAlreadyExists]: {
    message: 'private-chat-room-already-exists-error-response',
    level: RESPONSE_LEVEL.Toast,
  },
  [API_RESPONSE_TYPES.NotChatRoomMember]: {
    message: 'not-chat-room-member-error-response',
    level: RESPONSE_LEVEL.Toast,
  },
  [API_RESPONSE_TYPES.MustBeGradeProfessorIfGroupProfessor]: {
    message: 'must-be-grade-professor-if-group-professor-error-response',
    level: RESPONSE_LEVEL.Toast,
  },
  [API_RESPONSE_TYPES.MustBeGroupProfessorIfGradeProfessor]: {
    message: 'must-be-group-professor-if-grade-professor-error-response',
    level: RESPONSE_LEVEL.Toast,
  },
  [API_RESPONSE_TYPES.NotOrganizationMember]: {
