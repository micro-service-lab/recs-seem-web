...
import IconPlusBox from "@/components/Icon/IconPlusBox";
...
import { useAddMemberOnChatRoomQuery } from "@/api/chatRoom/useAddMemberOnChatRoom";
import IconInvite from "@/components/Icon/IconInvite";
...
export const InviteMemberList = ({
  ...
  >([]);
  const { mutate: addMemberOnChatRoom } =
    useAddMemberOnChatRoomQuery(chatRoomId);
  const { data } =
    useGetMembersQuery<GetMembersWithCrewAndProfileImageAndAttendStatusResponse>(
      {
        ...
        searchNotBelongingChatRoomId: chatRoomId,
        order: "default",
        limit: perPage,
                ...
                >
                  <div className="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-2">
                    <h5 className="font-bold text-lg">
                      {chatT("chat-room-invite-member-title")}
                    </h5>
                    <button
                      type="button"
                  ...
                  <div className="p-3">
                    <p className="text-sm mb-4">
                      {chatT("chat-room-invite-member-message-confirm", {
